...
@section('content')
    ...
    <div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
                <img src="/pictures/eggs.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
            ...
            <div class="span6">
                ...
                <hr class="soft"/>
                <form class="form-horizontal qtyFrm" action="{{ route('addtocart',$product->id) }}" method="POST">
                    @csrf
                <div class="control-group">
                    <label class="control-label"><span>${{ $product->id }}</span></label>
                    <div class="controls">
                ...
                <hr class="soft"/>
                <h4>{{ $product->quntity }} items in stock</h4>
